...
namespace ImageViewer.API.Controllers
{
    ...
    public class S3ProxyController : Controller
    {
        ...
        public S3ProxyController(IConfiguration configuration, ILogger<S3ProxyController> logger, IAmazonS3 s3Client, IImagesRepository imagesRepository)
        {
            this.Logger = logger;
        ...
        [HttpDelete()]
        public async Task Delete([FromQuery] string id, [FromQuery] string key)
        {
            ...
            try
            {
                ...
                await imagesRepository.DeleteAsync(id, key);
                Logger.LogInformation($"Deleted object {key} from database.");
            }
            catch (AmazonS3Exception e)
            {
                this.Response.StatusCode = (int)e.StatusCode;
